...
**Reason**: Same as above — the `/trip-costs` page is deleted and "Danh mục chi phí" nav link is removed.
**Migration**: The page no longer exists. Navigation to `/trip-costs` returns 404.
