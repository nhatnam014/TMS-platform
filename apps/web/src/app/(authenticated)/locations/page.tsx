...
export default function LocationsPage() {
  ...
  const locationTypeOptions = LOCATION_TYPES.map((t) => ({
    value: t,
                    ...
                    <div style={{ display: "flex", gap: 8 }}>
                      ...
                      <button
                        ...
                        style={{
                          ...
                          fontSize: 13,
                          cursor: "pointer",
                          opacity: deactivating === l.id ? 0.6 : 1,
                        }}
                      >
                        Xoá
                      </button>
      ...
      {showCreate && (
        ...
        >
          ...
          <SelectField
            ...
            onChange={(v) => setCreateForm((f) => ({ ...f, locationType: v as LocationType }))}
      ...
      {editTarget && (
        ...
        >
          ...
          <SelectField
            ...
            onChange={(v) => setEditForm((f) => ({ ...f, locationType: v as LocationType }))}
            options={locationTypeOptions}
            required
          />
