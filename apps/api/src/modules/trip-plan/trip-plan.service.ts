    ...
    return this.prisma.$transaction(async (tx) => {
      const trip = await tx.tripPlan.create({
        data: {
          ...
          luongName: dto.luongName ?? null,
          luongAmount: dto.luongAmount ?? null,
          shdLuong: dto.shdLuong ?? null,
          cuocName: dto.cuocName ?? null,
          cuocAmount: dto.cuocAmount ?? null,
          shdCuoc: dto.shdCuoc ?? null,
          doanhThuName: dto.doanhThuName ?? null,
          doanhThuAmount: dto.doanhThuAmount ?? null,
          shdDoanhThu: dto.shdDoanhThu ?? null,
          phuThuName: dto.phuThuName ?? null,
          phuThuAmount: dto.phuThuAmount ?? null,
          shdPhuThu: dto.shdPhuThu ?? null,
          chiPhiName: dto.chiPhiName ?? null,
          chiPhiAmount: dto.chiPhiAmount ?? null,
          shdChiPhi: dto.shdChiPhi ?? null,
          tienDauName: dto.tienDauName ?? null,
          tienDauAmount: dto.tienDauAmount ?? null,
          shdTienDau: dto.shdTienDau ?? null,
          neoXeName: dto.neoXeName ?? null,
          neoXeAmount: dto.neoXeAmount ?? null,
          shdNeoXe: dto.shdNeoXe ?? null,
        },
        include: {
          customer: true,
          carrier: true,
    ...
    return this.prisma.$transaction(async (tx) => {
      const updated = await tx.tripPlan.update({
        ...
        data: {
          ...
          ...(dto.luongName !== undefined && { luongName: dto.luongName }),
          ...(dto.luongAmount !== undefined && { luongAmount: dto.luongAmount }),
          ...(dto.shdLuong !== undefined && { shdLuong: dto.shdLuong }),
          ...(dto.cuocName !== undefined && { cuocName: dto.cuocName }),
          ...(dto.cuocAmount !== undefined && { cuocAmount: dto.cuocAmount }),
          ...(dto.shdCuoc !== undefined && { shdCuoc: dto.shdCuoc }),
          ...(dto.doanhThuName !== undefined && { doanhThuName: dto.doanhThuName }),
          ...(dto.doanhThuAmount !== undefined && { doanhThuAmount: dto.doanhThuAmount }),
          ...(dto.shdDoanhThu !== undefined && { shdDoanhThu: dto.shdDoanhThu }),
          ...(dto.phuThuName !== undefined && { phuThuName: dto.phuThuName }),
          ...(dto.phuThuAmount !== undefined && { phuThuAmount: dto.phuThuAmount }),
          ...(dto.shdPhuThu !== undefined && { shdPhuThu: dto.shdPhuThu }),
          ...(dto.chiPhiName !== undefined && { chiPhiName: dto.chiPhiName }),
          ...(dto.chiPhiAmount !== undefined && { chiPhiAmount: dto.chiPhiAmount }),
          ...(dto.shdChiPhi !== undefined && { shdChiPhi: dto.shdChiPhi }),
          ...(dto.tienDauName !== undefined && { tienDauName: dto.tienDauName }),
          ...(dto.tienDauAmount !== undefined && { tienDauAmount: dto.tienDauAmount }),
          ...(dto.shdTienDau !== undefined && { shdTienDau: dto.shdTienDau }),
          ...(dto.neoXeName !== undefined && { neoXeName: dto.neoXeName }),
          ...(dto.neoXeAmount !== undefined && { neoXeAmount: dto.neoXeAmount }),
          ...(dto.shdNeoXe !== undefined && { shdNeoXe: dto.shdNeoXe }),
        },
      });
